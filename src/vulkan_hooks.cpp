...
namespace VK {
    void Hook(HWND hwnd) {
        ...
        if (fnAcquireNextImageKHR) {
            ...
            static lm_size_t aniStatus = LM_HookCode(reinterpret_cast<lm_address_t>(fnAcquireNextImageKHR), (lm_address_t)&hkAcquireNextImageKHR, reinterpret_cast<lm_address_t *>(&oAcquireNextImageKHR));
            static lm_size_t ani2Status = LM_HookCode(reinterpret_cast<lm_address_t>(fnAcquireNextImage2KHR), (lm_address_t)&hkAcquireNextImage2KHR, reinterpret_cast<lm_address_t *>(&oAcquireNextImage2KHR));
            static lm_size_t qpStatus = LM_HookCode(reinterpret_cast<lm_address_t>(fnQueuePresentKHR), (lm_address_t)&hkQueuePresentKHR, reinterpret_cast<lm_address_t *>(&oQueuePresentKHR));
            static lm_size_t csStatus = LM_HookCode(reinterpret_cast<lm_address_t>(fnCreateSwapchainKHR), (lm_address_t)&hkCreateSwapchainKHR, reinterpret_cast<lm_address_t *>(&oCreateSwapchainKHR));
